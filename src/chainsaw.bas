...
Private Type ConfigSettings
    ...
    Private Function LoadConfiguration() As Boolean: LoadConfiguration = modConfig_LoadConfiguration(): End Function
    Private Function LoadConfigIfNeeded() As Boolean: LoadConfigIfNeeded = modConfig_LoadConfigIfNeeded(isConfigLoaded): If LoadConfigIfNeeded Then isConfigLoaded = True
    End Function
