...
Private Function ApplyStdParagraphs(doc As Document) As Boolean
    ' Delegated to modFormatting after migration.
    ApplyStdParagraphs = modFormatting.ApplyStdParagraphs(doc)
End Function
...
Private Function FormatSecondParagraph(doc As Document) As Boolean
    FormatSecondParagraph = modFormatting.FormatSecondParagraph(doc)
End Function
...
Private Function EnsureSecondParagraphBlankLines(doc As Document) As Boolean
    EnsureSecondParagraphBlankLines = modFormatting.EnsureSecondParagraphBlankLines(doc)
End Function
...
Private Function FormatFirstParagraph(doc As Document) As Boolean
    FormatFirstParagraph = modFormatting.FormatFirstParagraph(doc)
End Function
