...
- **Windows**: ` # Instala̤̣o Local - Chainsaw
...
[i] Verificando acesso ao caminho:  # Instala̤̣o Local - Chainsaw
...
[i] Origem:  # Instala̤̣o Local - Chainsaw
...
.Value -replace 'CHAINSAW', 'chainsaw' \assets\stamp.png
[i] Destino:  # Instala̤̣o Local - Chainsaw
...
.Value -replace 'CHAINSAW', 'chainsaw' \configs\Templates
[i] Destino: C:\Users\csantos\AppData\Roaming\Microsoft\Templates
[OK] Pasta Templates copiada com sucesso (37 arquivos) [OK]
